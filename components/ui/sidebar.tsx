...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-4 py-4 hidden  md:flex md:flex-col bg-slate-100 dark:bg-slate-800 w-[300px] flex-shrink-0",
          className
        )}
        animate={{
      ...
      >
        ...
        <AnimatePresence>
          {open && (
            ...
            >
              <div
                className="absolute right-10 top-10 z-50 text-slate-800 dark:text-slate-200"
                onClick={() => setOpen(!open)}
              >
                <IconX />
              </div>
